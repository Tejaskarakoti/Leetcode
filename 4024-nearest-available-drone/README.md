<h2><a href="https://leetcode.com/problems/nearest-available-drone/description/">4024. Nearest Available Drone</a></h2><h3>Easy</h3><hr><p>You are given a 2D integer array <code>drones</code>, where <code>drones[i] = [x<sub>i</sub>, y<sub>i</sub>, range<sub>i</sub>]</code> represents the x-coordinate, y-coordinate, and travel range of the <code>i<sup>th</sup></code> drone.</p>
